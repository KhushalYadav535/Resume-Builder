  ...
  return (
    <div className="flex flex-col h-full w-full">
      ...
      <div className="space-y-4">
        <div>
          ...
          <input 
            ...
            className="w-full p-3 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-transparent focus:border-uprole-blue outline-none"
          />
        </div>
      ...
      <button
        onClick={nextCard}
        disabled={!isComplete}
        className="mt-8 w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-brand-navy py-4 rounded-full font-bold disabled:opacity-50 transition-all shadow-md shadow-amber-500/20"
      >
        Continue
      </button>
    </div>
