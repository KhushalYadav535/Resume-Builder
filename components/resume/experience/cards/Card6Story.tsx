    ...
    <div className="flex flex-col h-full w-full items-center text-center">
      ...
      <div className="w-full max-w-md mb-8">
        <textarea
          ...
          className="w-full h-32 p-4 rounded-2xl border-2 border-neutral-200 dark:border-neutral-800 bg-transparent focus:border-uprole-blue outline-none resize-none text-lg"
        />
      </div>
