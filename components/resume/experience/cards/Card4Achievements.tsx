    ...
    <div className="flex flex-col h-full w-full items-center text-center">
          ...
          <button
            ...
            className={cn(
              ...
              selected.includes(tag)
                ? "bg-uprole-teal border-uprole-teal text-white shadow-md"
                : "border-neutral-200 dark:border-neutral-800 hover:border-uprole-teal/60 bg-transparent text-neutral-700 dark:text-neutral-300"
            )}
          >
            {tag}
          </button>
      ...
      <div className="flex flex-col gap-3 w-full max-w-xs mx-auto">
        <button
          ...
          className="w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-brand-navy py-4 rounded-full font-bold disabled:opacity-50 transition-all shadow-md shadow-amber-500/20"
        >
          Continue
        </button>
        <button
