    ...
    <div className="flex flex-col h-full w-full items-center text-center">
      ...
      {!isGenerating && !roleData.title_ai_rewrite && (
        <div className="flex flex-col gap-3 w-full max-w-xs">
          <button
            onClick={handleYes}
            className="w-full p-4 rounded-full bg-blue-50/70 hover:bg-blue-100/80 dark:bg-uprole-blue/10 dark:hover:bg-uprole-blue/20 text-uprole-blue dark:text-blue-300 transition-all font-medium border border-blue-200/50 dark:border-blue-800/40"
          >
            Yes, it's clear
          </button>
          <button
      ...
      {isGenerating && (
        <div className="flex flex-col items-center mt-4">
          <Loader2 className="w-8 h-8 text-uprole-purple animate-spin mb-4" />
      ...
      {roleData.title_ai_rewrite && !roleData.title_rewrite_approved && (
        <div className="w-full mt-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-2xl p-6">
          <p className="text-sm text-uprole-blue dark:text-blue-400 font-medium mb-2">Suggested Rewrite</p>
          ...
          <div className="flex gap-3 justify-center">
            <button 
              ...
              className="px-6 py-2 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-brand-navy rounded-full font-bold shadow-md shadow-amber-500/20"
            >
              Accept
            </button>
            <button 
