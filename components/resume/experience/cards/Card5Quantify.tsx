    ...
    <div className="flex flex-col h-full w-full items-center text-center">
      ...
      <div className="w-full max-w-sm mb-12">
        <input 
          ...
          className="w-full p-3 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-transparent focus:border-uprole-blue outline-none text-sm text-center"
        />
      </div>
      ...
      <div className="flex items-center justify-between w-full max-w-sm">
        ...
        <button
          ...
          className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-brand-navy px-8 py-3 rounded-full font-bold disabled:opacity-50 transition-all shadow-md shadow-amber-500/20"
        >
