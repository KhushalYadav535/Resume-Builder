...
9. "linkedin_url" MUST be a valid URL (e.g. linkedin.com/in/...). If it is not found, leave it as an empty string. DO NOT put "Contact Information" or names in this field.
